package dev.topping.kotlin.compose.gradle.documentparser;

import com.google.common.collect.ImmutableSet;
import com.google.common.reflect.ClassPath;
import dev.topping.kotlin.compose.gradle.json.JSONArray;
import dev.topping.kotlin.compose.gradle.json.JSONObject;
...
public class DocumentParser
{
    ...
    {
        public String name;
        public ArrayList<FunctionParDef> parameters;
        public HashMap<String, String> parameterDetails;
    ...
    private static void RunParserForFolder(String p) throws Exception
    {
        ...
        for (File file : dir.listFiles())
        {
					...
					|| filename.startsWith("classandroidx_1_1fragment_1_1app_1_1"))
            {
				...
				ArrayList<MemberDef> variables = new ArrayList<MemberDef>();
                for(int i = 0; i < nsModule.getLength(); i++)
                {
                    Node n = nsModule.item(i);
    ...
    public static HashMap<String, JSONObject> jsonMap = new HashMap<String, JSONObject>();
    public static HashMap<String, String> androidMap = new HashMap<String, String>();
    public static HashMap<String, String> sharedMap = new HashMap<String, String>();
    public static HashMap<String, String> iosMap = new HashMap<String, String>();
	...
	public static class ListLoadedClassesAgent {
	...
	public static void ResourceLoader(String path, boolean kotlin, String clsname) throws Exception
	{
		...
		for(ClassPath.ClassInfo cc : classes)
			if(cc.getName().contains("dev.topping"))
